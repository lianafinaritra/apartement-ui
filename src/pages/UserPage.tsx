                                ...
                                <div
                                    ...
                                    <div className="flex-auto p-5 lg:p-10">
                                        ...
                                        <div className="relative w-full mb-3">
                                            ...
                                            <textarea
                                                className="grid-rows-4 grid-cols-2 border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full"
